        ...
        {!saveFlag &&
          <div>
            ...
            <div className='flex justify-center gap-4'>
              ...
              <button onClick={e => { setSaveFlag(!saveFlag); getData(); setTodo({ task: "", desc: "", date: "" }) }} className='flex justify-center items-center w-28 p-2 mt-6 bg-white text-black hover:font-bold border hover:shadow-xl rounded-lg'>Cancel</button>
            </div>
          </div>
        }
